...
## {background-image="images/shared/ascii_table.svg" background-size="92%"}
...
* You can enter c-strings using **`>>`** (stream extraction).
    ...
    - [**No bounds-checking is performed!**]{.red}
...
* You **cannot** directly _assign_ c-strings.
    - [Why?  **They are _arrays_!** ]{.highlight}
