...
Dijkstra's Algorithm is a method for finding the **_shortest path_** from a given _starting node_ in a graph to all other nodes that are reachable from that starting node.
