...
It can sometimes be useful to allow these constants to be _global_ in some cases (as we will see shortly).
:::
...
_Think "[for each row]{.highlight-blue}, [for each column]{.highlight-green}, do some operation"._
