...
![Rotate Left - $Q$ is the pivot node.](images/avl_tree/tree_rotate_left.svg "Rotate Left - $Q$ is the pivot node.")
...
(c) A single **_left rotation_** is performed at node _P_.  This results in _Q_ becoming the parent of _P_, and the tree is again balanced.  (Note that _Q_'s left subtree became _P_'s right subtree in the rotation.)
:::
