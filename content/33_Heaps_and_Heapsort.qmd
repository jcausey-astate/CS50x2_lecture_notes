...
textbook: "Drozdek (Ch. 6.9)"
draft: false
---

## Heaps

A **_heap_** is a kind of (usually binary) tree.  They normally^\*^ come in two varieties:

* **_Min-Heaps_** always maintain the smallest value at the root.
* **_Max-Heaps_** always maintain the largest value at the root.

:::{.aside}
^\*^ \ \ There is also a more exotic heap called a "**_min-max-heap_**" that allows you
...
![Complete Binary Max Heap](images/HeapSort/complete_binary_max_heap.png)

---

## Binary Min Heap

![Complete Binary Min Heap](images/HeapSort/incomplete_binary_min_heap.png)
...
![Max Heap in Array](images/HeapSort/heap_in_array_both_views.svg)
::::
:::
