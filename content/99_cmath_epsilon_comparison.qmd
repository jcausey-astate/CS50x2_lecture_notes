...
textbook: "Gaddis (Ch. 4) Supplement"
draft: false
---
...
The problem is that the `==` operator is often [_too strict a test_]{.red}.  What we really want to know is whether the values are "equal" to _within an acceptable tolerance_.
